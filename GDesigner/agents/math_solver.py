...
class MathSolver(Node):
    def __init__(self, id: Optional[str] =None, role:str = None, domain: str = "", llm_name: str = "", constraint: str = None):
    ...
    def _process_inputs(self, raw_inputs:Dict[str,str], spatial_info:Dict[str,Dict], temporal_info:Dict[str,Dict], **kwargs)->List[Any]:
        ...
        if self.role == "Math Solver" or self.role == "Math Solver for choice question":
