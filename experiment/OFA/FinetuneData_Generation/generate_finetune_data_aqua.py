...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate supervised fine-tuning data for OFA on AQuA.")
    parser.add_argument('--dataset_json', type=str, default="../../../datasets/AQuA/AQuA.jsonl", help="Path to AQuA JSONL dataset")
    ...
    parser.add_argument('--domain', type=str, default="aqua", help="Task domain name")
...
async def main():
    ...
    print(f"Generating AQuA fine-tuning data for {len(configs)} configurations...")
    ...
    print("All AQuA fine-tuning data generation complete.")
